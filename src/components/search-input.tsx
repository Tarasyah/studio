        ...
        <div className="relative" ref={searchContainerRef}>
            <form onSubmit={handleSearch} className="relative">
                ...
                <Input
                  ...
                  className="w-full pl-11 pr-4 py-2 bg-white/10 border-white/20 rounded-full shadow-sm placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white text-white"
                  autoComplete="off"
                />
            </form>
